...
public class Client_IncompleteCertificatesPage extends DriverLoad {
	...
	@FindBy(xpath = ".//*[@id='mainContainer']/div[4]/div[2]/div/table/tbody/tr[1]/td[8]/a")
	...
	public Client_IncompleteCertificatesPage(WebDriver driver){

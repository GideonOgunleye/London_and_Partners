...
public class Client_IssuedCertificatesPage extends DriverLoad {
	...
	@FindBy(xpath = ".//*[@class='stdContentWrapper']/div/table/tbody/tr[1]/td[10]/a")
	WebElement Product1;
	
	@FindBy(xpath = ".//*[@class='stdContentWrapper']/div/table/tbody/tr[2]/td[10]/a")
	WebElement Product2;
	
	@FindBy(xpath = ".//*[@class='stdContentWrapper']/div/table/tbody/tr[3]/td[10]/a")
	WebElement Product3;
	
	@FindBy(xpath = ".//*[@class='stdContentWrapper']/div/table/tbody/tr[4]/td[10]/a")
	WebElement Product4;
	
	@FindBy(xpath = ".//*[@class='stdContentWrapper']/div/table/tbody/tr[5]/td[10]/a")
	WebElement Product5;
	
	
	
	public Client_IssuedCertificatesPage(WebDriver driver){

...
public class Client_MySslDashBoard extends DriverLoad {
	...
	@FindBy(xpath = ".//*[@id='mainContainer']/div[4]/div[1]/ul[1]/li[7]/ul/li[3]/a")
	...
	public Client_MySslDashBoard(WebDriver driver){

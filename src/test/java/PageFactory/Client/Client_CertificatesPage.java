...
public class Client_CertificatesPage extends DriverLoad {
	...
	WebElement Col1_Status;
	
	@FindBy(xpath = ".//*[@id='DataTables_Table_0']/tbody/tr[2]/td[5]")
	WebElement Col2_Status;
	
	@FindBy(xpath = ".//*[@id='DataTables_Table_0']/tbody/tr[1]/td[8]/a")
	WebElement Col1_ViewButton;
	
	@FindBy(xpath = ".//*[@id='DataTables_Table_0']/tbody/tr[2]/td[8]/a")
	WebElement Col2_ViewButton;
	
	
	public Client_CertificatesPage(WebDriver driver){
	...
	public void ForFieldSelect_AccountName(){
	...
	public void StatusFieldSelect_Issued(){
		
		Select StatusOptions = new Select(StatusField);
		StatusOptions.selectByValue("13");
	...
	public boolean Col1_Contains(String AccountName){
		
		return Col1.getText().contains(AccountName);

	
	}
	
	public boolean Col2_Contains(String AccountName){
		
		return Col2.getText().contains(AccountName);
		
	}
	
	public boolean Col1_StatusContains(String Status){
		
		return Col1_Status.getText().contains(Status);

	}
	
	public boolean Col2_StatusContains(String Status){
		
		return Col2_Status.getText().contains(Status);

	}
	
	public void Col1_ViewButtonClick(){
		
		Col1_ViewButton.click();
		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);

	}
	
	public void Col2_ViewButtonClick(){
		
		Col2_ViewButton.click();
		driver.manage().timeouts().implicitlyWait(50, TimeUnit.SECONDS);

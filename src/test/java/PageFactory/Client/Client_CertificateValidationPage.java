...
public class Client_CertificateValidationPage extends DriverLoad {
	...
	WebElement CertificatesDetailsTab;
	...
	*/
	...
	public Client_CertificateValidationPage(WebDriver driver){
